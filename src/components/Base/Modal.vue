<template>
  ...
  <transition name="modal-fade">
    <div
      class="modal modal-lg-fullscreen  rj-modal-con fade"
      :class="[{ 'd-block show': showModalToggle }]"
      tabindex="-1"
      role="dialog"
      aria-hidden="true"
    >
...
export default defineComponent({
  ...
  components: {},
  setup: (props, context) => {
    const showModalToggle = ref(false);
    ...
    const modalClassTogal = computed(() => {
      return showModalToggle.value ? 'show' : 'hide';
    });
