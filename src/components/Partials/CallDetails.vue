              ...
              <div class="card-options">
                ...
                >
                  <template v-slot:menus>
                    <a class="dropdown-item" href="javascript:void(0)" @click="clearCallLogs"
                      >Clear Call Log</a
                    >
                    <a class="dropdown-item" @click="blockUser" href="javascript:void(0)">Block </a>
                  </template>
                </DropdownWithSlot>
              </div>
              ...
              <div class="card-body">
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    >
                      <p class="text-muted mb-0">{{ timeAgo(history.time) }}</p>
                      <span
                        class="d-none d-sm-block text-muted mx-2"
                        v-if="history.type != 'missed-calls'"
                        >•</span
                      >
                      <p class="text-muted mb-0" v-if="history.type != 'missed-calls'">
                        {{ timeDiff(history.time, history.end_time) }}
                      </p>
                    </div>
                  </div>
