<template>
  <ul class="contacts-list" id="chatContactTab">
    <li
      ...
      :class="[{ active: convId == conversation.uuid }]"
      ...
      <a class="contacts-link" href="javascript:void(0)" @click="openConversation(conversation)">
        ...
        <div class="contacts-content">
          <div class="contacts-info">
            <h6 class="chat-name text-truncate">{{ conversation.name }}</h6>
          ...
          <div class="contacts-texts">
            ...
            <div
              class="badge badge-rounded badge-primary ml-1"
...
export default defineComponent({
  ...
  setup: () => {
    ...
    function openConversation (conversation: sgconvdetail): void {
