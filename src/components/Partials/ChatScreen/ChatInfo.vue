    ...
    <div class="d-flex h-100 flex-column">
      ...
      <div class="hide-scrollbar flex-fill">
        ...
        <div class="chat-info-group">
          ...
          <div
            class="chat-info-group-body collapse"
        ...
        <div class="chat-info-group">
          <a
            class="chat-info-group-header"
            :class="[{ collapsed: !showMediaInfo }]"
            @click="toggleMediaInfoBox"
            data-toggle="collapse"
            href="javascript:void(0)"
            role="button"
            :aria-expanded="showMediaInfo"
          ...
          >
            <div class="chat-info-group-content">
              ...
              <div class="form-row">
                <div
                  class="col-4 col-md-2 col-xl-4"
                  v-if="currentConversation.last_media"
        ...
        <div class="chat-info-group">
          <a
            class="chat-info-group-header"
            :class="[{ collapsed: !showDocumentInfo }]"
            data-toggle="collapse"
            href="javascript:void(0)"
            @click="toggleDocumentInfoBox"
            role="button"
            :aria-expanded="showDocumentInfo"
            ...
            <div class="chat-info-group-content list-item-has-padding">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li
                  ...
                  v-if="currentConversation.last_documents"
                  ...
                  <div class="document">
                    ...
                    <div class="document-options ml-1">
                      <DropdownWithSlot
                        ...
                        dpstyle="position: absolute; transform: translate3d(-111px, 48px, 0px); top: 0px; left: 0px; will-change: transform;"
                      >
                        <template v-slot:menus>
                          <a
                            ...
                            >Download</a
                          >
                          <a class="dropdown-item" @click="shareDoc(doc)" href="javascript:void(0)"
                            >Share</a
                          >
                          <a class="dropdown-item" @click="deleteDoc(doc)" href="javascript:void(0)"
                            >Delete</a
                          >
                        </template>
                      </DropdownWithSlot>
