...
export interface Actions {
  [ActionTypes.LOAD_CONVERSATION]({ commit }: AugmentedActionContext, payload: Object): void;
  [ActionTypes.LOAD_CALLHISTORY]({ commit }: AugmentedActionContext, payload: Object): void;
  [ActionTypes.LOAD_FRIEND]({ commit }: AugmentedActionContext, payload: Object): void;
  [ActionTypes.LOAD_USERDETAIL]({ commit }: AugmentedActionContext, payload: string): void;
  [ActionTypes.LOAD_SEARCHTEXT]({ commit }: AugmentedActionContext, payload: Object): void;
}

export const actions: ActionTree<State, State> & Actions = {
  [ActionTypes.LOAD_CONVERSATION] ({ commit }, payload: Object) {
    // Ajax call will be here.
    Friends.getConversationDetail(payload)
  ...
  [ActionTypes.LOAD_FRIEND] ({ commit }, payload: Object) {
    ...
    Friends.getFriendDetail(payload)
      .then((response: ResponseType) => {
